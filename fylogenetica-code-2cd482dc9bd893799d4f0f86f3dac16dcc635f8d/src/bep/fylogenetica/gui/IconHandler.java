...
public class IconHandler {
	...
	public static ImageIcon getIcon(String path) {
		...
		URL f = Fylogenetica.class.getResource("/res" + System.getProperty("file.separator") + path + ".png");
	...
	public static ImageIcon getIconEmblemed(String path, String emblemPath) {
		...
		f = Fylogenetica.class.getResource("/res" + System.getProperty("file.separator") + emblemPath + ".png");
